...
static const uint16_t channel_pins[] = {
    ...
    GPIO_PIN_0, GPIO_PIN_1, GPIO_PIN_2, GPIO_PIN_11, GPIO_PIN_12, GPIO_PIN_14,
...
void analog_init(void) {
  ...
  tim_handle.Init.Period = (SystemCoreClock / 1000000) * ADC_SAMPLE_DELAY - 1;
...
void ADC1_2_IRQHandler(void) { HAL_ADC_IRQHandler(&adc_handle); }

void DMA1_Channel1_IRQHandler(void) { HAL_DMA_IRQHandler(&dma_handle); }

#if ADC_NUM_MUX_INPUTS > 0
void TIM4_IRQHandler(void) { HAL_TIM_IRQHandler(&tim_handle); }
#endif
